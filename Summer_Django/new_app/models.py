...
class Clash(models.Model):
    clashread = models.TextField(db_column='CLASHRead', primary_key=True)  # Field name made lowercase.
    clashreadlength = models.IntegerField(db_column='CLASHReadLength', blank=True, null=True)  # Field name made lowercase.
    ...
    smallrnasequence = models.TextField(db_column='SmallRNASequence', blank=True, null=True)  # Field name made lowercase.
    smallrnalength = models.IntegerField(db_column='SmallRNALength', blank=True, null=True)  # Field name made lowercase.
    ...
    targetrnalength = models.IntegerField(db_column='TargetRNALength', blank=True, null=True)  # Field name made lowercase.
    ...
    predictedtargetsite = models.TextField(db_column='PredictedTargetSite', blank=True, null=True)  # Field name made lowercase.
    rnaupscore = models.FloatField(db_column='RNAupScore', blank=True, null=True)  # Field name made lowercase.
    number_5to3pairedsequenceintargetrna = models.TextField(db_column='5to3PairedSequenceinTargetRNA', blank=True, null=True)  # Field name made lowercase. Field renamed because it wasn't a valid Python identifier.
    number_5to3pairedsequenceinsmallrna = models.TextField(db_column='5to3PairedSequenceinSmallRNA', blank=True, null=True)  # Field name made lowercase. Field renamed because it wasn't a valid Python identifier.
    sequnceonclashreadidentifiedastargetrna = models.TextField(db_column='SequnceonCLASHReadidentifiedasTargetRNA', blank=True, null=True)  # Field name made lowercase.
    lengthonclashreadidentifiedastargetrna = models.IntegerField(db_column='LengthonCLASHReadidentifiedasTargetRNA', blank=True, null=True)  # Field name made lowercase.
