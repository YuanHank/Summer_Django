...
import pandas as pd
import numpy as np
from .models import Hw1Improve,User,Wormbase285,WormbaseGenetranscriptW285
import json
...
def pirscan_ajax(request):
    ...
    try:
        with open ('piRNA_targeting_sites.json','r') as jsondata:
        ...
        for item in newout:
            ...
            #print(index)
            modify_string = '<div class="modify">'+item[10][:index]+'</div>'+item[10][index:]
...
#this function is used to work with transcriptgene site,
